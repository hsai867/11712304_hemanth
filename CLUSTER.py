'''
Question: Analyze the difficulty level of a particular course using clustering techniques
Dataset : Bachelor of Technology in Biotechnology - Master of Business Administration (Integrated)
...
# Keep all the rows with MHRDName is 'Bachelor of Technology in Biotechnology - Master of Business Administration (Integrated)'
dataset = dataset[dataset.MHRDName == 'Integrated Bachelor of Technology - Master of Technology (Biotechnology)']

# No need of MHRDName column... as we are already dealing with 'Bachelor of Technology in Biotechnology - Master of Business Administration (Integrated)' department
...
#-----------------------------------------------------------------#
# Convert all the grades of the student to the level of difficulty
difficulty_level = []
easy = ['A','A+','O']
medium = ['B+','B','C','D']
difficul = ['E','F','R','M']
